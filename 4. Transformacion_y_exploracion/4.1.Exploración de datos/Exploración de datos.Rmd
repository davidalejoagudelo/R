...
```
Se observar que hay hogares con muchos integrantes per es algo atípico
...
Se ve que el histograma no funciona porque cubre algunas clases, para eso está ña geometría "freqpoy". Este no tiene fondo
...
Es una variabl categórica pero por ser números es continua
...
No nos casamos on esta porque hay mucha diferencia entre los hogares nucleares y el resto de los hogares.
